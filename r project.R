...
install.packages(c("ggplot2","corrgram","DMwR","caret","randomForest","unbalanced","C50","e1071"))

library(ggplot2,corrgam,DMwr,caret,randomForest,unbalanced,c50,e1071,glm)
x = c("ggplot2", "corrgram", "DMwR", "caret", "randomForest", "unbalanced", "C50", "e1071")
lapply(x, require, character.only = TRUE)
install.packages(c("psych","Scales","ROCR","CaTools"))
library(psych)
library(Scales)
library(ROCR)
library(caTools)

train_data = read.csv('E:/Edwisor/project/Train_data.csv', header = T)
test_data = read.csv('E:/Edwisor/project/Test_data.csv', header = T)
